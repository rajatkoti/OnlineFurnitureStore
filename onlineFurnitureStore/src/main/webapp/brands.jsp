...
<%@ page import="org.aricent.model.Brand" %>    
 ...
 %>   	
        <div class="main-container">
          <div class="col-lg-12 col-md-12 col-sm-12">
           ...
           <%
           ArrayList<Brand> arr= null;
           Object result = request.getAttribute("brand_list");
           arr = (ArrayList<Brand>) result;
           
           for(int i=0;i<arr.size();i++) {
           %>
                <tr style="color:#eee;">
                    <td><%= arr.get(i).getBrand_id()  %></td>
