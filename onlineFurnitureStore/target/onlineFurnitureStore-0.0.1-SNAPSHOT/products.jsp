          ...
          <div class="col-lg-12 col-md-12 col-sm-12">
           ...
           <table class="table">
            <tr class="table-header">
                    ...
                    <th class="cell">Product Category</th>
                    <th class="cell">Product Brand</th>
                    <th class="cell">Product Quantity</th>
                    <th class="cell">Product Price</th>
                    <th class="cell">Discount</th>
                    <th class="cell">Updated Price</th>
                    <th class="cell">Actions</th>
                </tr>
           <%
           ArrayList<Product> arr= null;
           Object result = request.getAttribute("productList");
           arr = (ArrayList<Product>) result;
           
           for(int i=0;i<arr.size();i++) {
           %>
                <tr style="color:#eee;">
                    <td><%= arr.get(i).getProduct_id() %></td>
                    <td><%= arr.get(i).getProduct_name() %></td>
                    <td><%= arr.get(i).getProduct_category()%></td>
                    <td><%= arr.get(i).getBrand_name()%></td>
                    <td><%= arr.get(i).getQuantity()%></td>
                    <td><%= arr.get(i).getPrice() %></td>
                    <td><%= arr.get(i).getDiscount()%></td>
                    <td><%= arr.get(i).getActualPrice()%></td>
