...
<%@ page import="org.aricent.model.Categor" %>    
 ...
 %>   	
        <div class="main-container">
          <div class="col-lg-12 col-md-12 col-sm-12">
           ...
           <%
           ArrayList<Categor> arr= null;
           Object result = request.getAttribute("category_list");
           arr = (ArrayList<Categor>) result;
           
           for(int i=0;i<arr.size();i++) {
           %>
                <tr style="color:#eee;">
                    <td><%= arr.get(i).getCategory_id()  %></td>
                    <td><%= arr.get(i).getCategory_name() %></td>
